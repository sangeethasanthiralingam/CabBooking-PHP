...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $query = "INSERT INTO cab_list (category_id, cab_reg_no, cab_model, body_no, cab_driver, driver_contact, driver_address, password, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
  ...
  // Bind parameters
  $stmt->bind_param("isssssssi", $category_id, $cab_reg_no, $cab_model, $body_no, $cab_driver, $driver_contact, $driver_address, $password, $status);
      ...
      <div class="card card-outline card-purple w-75">
        ...
        <div class="card-body">
          ...
          <div class="card card-outline card-purple rounded-0">
            ...
            <div class="card-body">
              <form method="POST" action="" id="cab-form">
