                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button type="button" class="btn btn-flat btn-info border btn-sm view_rate" data-id="<?= $row['id'] ?>">Rate</button>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
...
<script>
    $(function(){
        ...
        $('.view_rate').click(function(){
            uni_modal("Rating Details","view_rating.php?id="+$(this).attr('data-id'))
        })
    })
</script>